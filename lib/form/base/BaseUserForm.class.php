...
abstract class BaseUserForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'contact_information_id' => new sfWidgetFormPropelChoice(array('model' => 'Contact', 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'contact_information_id' => new sfValidatorPropelChoice(array('model' => 'Contact', 'column' => 'id', 'required' => false)),
