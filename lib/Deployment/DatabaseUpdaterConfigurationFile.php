...
* database updates. It is used to store the configuration of the database
* updates.
* 
* @author Steve Sperandeo <steve.sperandeo@altumo.com>
*/
class DatabaseUpdaterConfigurationFile extends \Altumo\Xml\XmlFile{
    ...
    * DatabaseUpdaterConfigurationFile.
    * 
