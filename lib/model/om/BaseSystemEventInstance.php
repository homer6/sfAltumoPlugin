...
/**
 * Base class that represents a row from the 'system_event_instance' table.
 *
 * 
 *
 * @package    propel.generator.plugins.sfAltumoPlugin.lib.model.om
 */
abstract class BaseSystemEventInstance extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
  const PEER = 'SystemEventInstancePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        SystemEventInstancePeer
	 */
	...
	public function setSystemEventId($v)
	{
		...
		if ($this->system_event_id !== $v) {
			...
			$this->modifiedColumns[] = SystemEventInstancePeer::SYSTEM_EVENT_ID;
		}
	...
	public function setMessage($v)
	{
		...
		if ($this->message !== $v) {
			$this->message = $v;
			$this->modifiedColumns[] = SystemEventInstancePeer::MESSAGE;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = SystemEventInstancePeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = SystemEventInstancePeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = SystemEventInstancePeer::NUM_COLUMNS - SystemEventInstancePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = SystemEventInstancePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				SystemEventInstanceQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseSystemEventInstance:save:pre') as $callable)
			{
			...
			if ($this->isModified() && !$this->isColumnModified(SystemEventInstancePeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(SystemEventInstancePeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseSystemEventInstance:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				SystemEventInstancePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(SystemEventInstancePeer::ID) ) {
					...
					$affectedRows += SystemEventInstancePeer::doUpdate($this, $con);
				}
	...
	{
		$pos = SystemEventInstancePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$criteria = new Criteria(SystemEventInstancePeer::DATABASE_NAME);
		$criteria->add(SystemEventInstancePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of SystemEventInstance (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     SystemEventInstance Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     SystemEventInstancePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new SystemEventInstancePeer();
		}
		return self::$peer;
	}
	 ...
	 * If this SystemEventInstance is new, it will return
		...
		if(null === $this->collSystemEventInstanceMessages || null !== $criteria) {
			if ($this->isNew() && null === $this->collSystemEventInstanceMessages) {
				...
				$collSystemEventInstanceMessages = SystemEventInstanceMessageQuery::create(null, $criteria)
					->filterBySystemEventInstance($this)
					->find($con);
				if (null !== $criteria) {
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseSystemEventInstance:' . $name))
		{
