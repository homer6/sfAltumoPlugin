...
abstract class BaseStatePeer {
	...
	const CLASS_DEFAULT = 'plugins.sfAltumoPlugin.lib.model.State';
	...
	const ISO_CODE = 'state.ISO_CODE';

	/** the column name for the ISO_SHORT_CODE field */
	const ISO_SHORT_CODE = 'state.ISO_SHORT_CODE';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'IsoCode', 'IsoShortCode', 'CountryId', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'isoCode', 'isoShortCode', 'countryId', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::ISO_CODE, self::ISO_SHORT_CODE, self::COUNTRY_ID, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'ISO_CODE', 'ISO_SHORT_CODE', 'COUNTRY_ID', 'CREATED_AT', 'UPDATED_AT', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'iso_code', 'iso_short_code', 'country_id', 'created_at', 'updated_at', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'IsoCode' => 2, 'IsoShortCode' => 3, 'CountryId' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'isoCode' => 2, 'isoShortCode' => 3, 'countryId' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::ISO_CODE => 2, self::ISO_SHORT_CODE => 3, self::COUNTRY_ID => 4, self::CREATED_AT => 5, self::UPDATED_AT => 6, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'ISO_CODE' => 2, 'ISO_SHORT_CODE' => 3, 'COUNTRY_ID' => 4, 'CREATED_AT' => 5, 'UPDATED_AT' => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'iso_code' => 2, 'iso_short_code' => 3, 'country_id' => 4, 'created_at' => 5, 'updated_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(StatePeer::ISO_CODE);
			$criteria->addSelectColumn(StatePeer::ISO_SHORT_CODE);
	...
	{
		$key = StatePeer::getPrimaryKeyHashFromRow($row, $startcol);
		if (null !== ($obj = StatePeer::getInstanceFromPool($key))) {
			// We no longer rehydrate the object, since this can cause data loss.
			// See http://www.propelorm.org/ticket/509
			// $obj->hydrate($row, $startcol, true); // rehydrate
			$col = $startcol + StatePeer::NUM_HYDRATE_COLUMNS;
		} else {
			$cls = StatePeer::OM_CLASS;
			$obj = new $cls();
	...
	/**
	 * Selects a collection of State objects pre-filled with their Country objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinCountry(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		StatePeer::addSelectColumns($criteria);
		$startcol = StatePeer::NUM_HYDRATE_COLUMNS;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (State) to $obj2 (Country)
				$obj2->addState($obj1);
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(StatePeer::ID);
			if ($value) {
				$selectCriteria->add(StatePeer::ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(StatePeer::TABLE_NAME);
			}
	...
	public static function doValidate($obj, $cols = null)
	{
		...
		return BasePeer::doValidate(StatePeer::DATABASE_NAME, StatePeer::TABLE_NAME, $columns);
	}
	...
	{
	  return array(array('iso_short_code'));
	}
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseStatePeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
